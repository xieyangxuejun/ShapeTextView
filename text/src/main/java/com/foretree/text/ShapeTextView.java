...
//        int solid = a.getColor(R.styleable.shapeTextView_textSolidColor, Color.TRANSPARENT);
        int strokeColor = a.getColor(R.styleable.shapeTextView_textStrokeColor, Color.TRANSPARENT);
        radius = a.getDimensionPixelSize(R.styleable.shapeTextView_textRadius, 0);
        int leftTopRadius = a.getDimensionPixelSize(R.styleable.shapeTextView_textLeftTopRadius, 0);
        int leftBottomRadius = a.getDimensionPixelSize(R.styleable.shapeTextView_textLeftBottomRadius, 0);
        int rightTopRadius = a.getDimensionPixelSize(R.styleable.shapeTextView_textRightTopRadius, 0);
        int rightBottomRadius = a.getDimensionPixelSize(R.styleable.shapeTextView_textRightBottomRadius, 0);
        strokeWidth = a.getDimensionPixelSize(R.styleable.shapeTextView_textStrokeWidth, 0);
        int normalTextColor = a.getColor(R.styleable.shapeTextView_textNormalTextColor, Color.TRANSPARENT);
        int selectedTextColor = a.getColor(R.styleable.shapeTextView_textSelectedTextColor, Color.TRANSPARENT);
        int normalSolidColor = a.getColor(R.styleable.shapeTextView_textNormalSolidColor, Color.TRANSPARENT);
        int pressedSolidColor = a.getColor(R.styleable.shapeTextView_textPressedSolidColor, Color.TRANSPARENT);
        boolean isSelected = a.getBoolean(R.styleable.shapeTextView_textIsSelected,false);
        boolean noLeftStroke = a.getBoolean(R.styleable.shapeTextView_textNoLeftStroke,false);
        boolean noRightStroke = a.getBoolean(R.styleable.shapeTextView_textNoRightStroke,false);
        boolean noTopStroke = a.getBoolean(R.styleable.shapeTextView_textNoTopStroke,false);
        boolean noBottomStroke = a.getBoolean(R.styleable.shapeTextView_textNoBottomStroke,false);
        Drawable textDrawable = a.getDrawable(R.styleable.shapeTextView_textDrawable);
